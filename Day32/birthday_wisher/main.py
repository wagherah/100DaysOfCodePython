...
#             conn.starttls()
#             conn.login('khalid@gmail.com', '*******')
#             conn.sendmail(from_addr='gmail.com', to_addrs='gmail.com', msg='Today is a birthday')
...
# automate the code by running it in cloud -> www.pythonanywhere.com
